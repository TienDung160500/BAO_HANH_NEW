...
class ChiTietSanPhamTiepNhanResourceIT {
    ...
    void createChiTietSanPhamTiepNhan() throws Exception {
        ...
        assertThat(testChiTietSanPhamTiepNhan.getSoLuong()).isEqualTo(DEFAULT_SO_LUONG);
    ...
    void putNewChiTietSanPhamTiepNhan() throws Exception {
        ...
        assertThat(testChiTietSanPhamTiepNhan.getSoLuong()).isEqualTo(UPDATED_SO_LUONG);
