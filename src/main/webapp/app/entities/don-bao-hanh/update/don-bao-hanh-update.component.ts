...
export class DonBaoHanhUpdateComponent implements OnInit {
  ...
  protected updateForm(donBaoHanh: IDonBaoHanh): void {
    this.editForm.patchValue({
      ...
      ngaykhkb: donBaoHanh.ngaykhkb ? donBaoHanh.ngaykhkb.format(DATE_TIME_FORMAT) : null,
      nguoiTaoDon: donBaoHanh.nguoiTaoDon,
      ghiChu: donBaoHanh.ghiChu,
      ngayTraBienBan: donBaoHanh.ngayTraBienBan ? donBaoHanh.ngayTraBienBan.format(DATE_TIME_FORMAT) : null,
  ...
  protected createFromForm(): IDonBaoHanh {
    return {
      ...
      ngaykhkb: this.editForm.get(['ngaykhkb'])!.value ? dayjs(this.editForm.get(['ngaykhkb'])!.value, DATE_TIME_FORMAT) : undefined,
      ...
      ngayTraBienBan: this.editForm.get(['ngayTraBienBan'])!.value
        ? dayjs(this.editForm.get(['ngayTraBienBan'])!.value, DATE_TIME_FORMAT)
        : undefined,
