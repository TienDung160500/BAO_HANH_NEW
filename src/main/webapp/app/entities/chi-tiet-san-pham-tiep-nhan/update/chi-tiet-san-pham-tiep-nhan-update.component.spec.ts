...
describe('ChiTietSanPhamTiepNhan Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    ...
    it('Should call PhanLoaiChiTietTiepNhan query and add missing value', () => {
      const chiTietSanPhamTiepNhan: IChiTietSanPhamTiepNhan = { id: 456 };
      const phanLoaiChiTietTiepNhan: IPhanLoaiChiTietTiepNhan = { id: 44167 };
      chiTietSanPhamTiepNhan.phanLoaiChiTietTiepNhan = phanLoaiChiTietTiepNhan;

      const phanLoaiChiTietTiepNhanCollection: IPhanLoaiChiTietTiepNhan[] = [{ id: 7357 }];
      jest
    ...
    it('Should update editForm', () => {
      ...
      chiTietSanPhamTiepNhan.donBaoHanh = donBaoHanh;
      const phanLoaiChiTietTiepNhan: IPhanLoaiChiTietTiepNhan = { id: 92087 };
      chiTietSanPhamTiepNhan.phanLoaiChiTietTiepNhan = phanLoaiChiTietTiepNhan;
